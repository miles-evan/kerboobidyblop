...
import SnapshotableTime from "@engine/multiplayer/SnapshotableTime.ts";
import GameState from "@engine/multiplayer/GameState.ts";
...
export default class Spell extends GameObject {
	...
	public power: Power;
	public readonly playerNum: PlayerNum; // player 1 is bottom->top, player 2 is top->bottom
	public board: Board;
	...
	public constructor(x: Pixels, y: Pixels, lane: Lane, tier: Tier, playerNum: PlayerNum, power: Power = "none", board: Board) {
		super(x, y, 16, 16, `/src/game/sprites/spells/spell-player${playerNum}-tier${tier}.png`);
		this.lane = lane;
		this.tier = tier;
